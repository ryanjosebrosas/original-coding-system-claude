# Root Cause Analysis: GitHub Issue #$ISSUE_NUMBER
...
Investigate this GitHub issue, identify the root cause, and document findings for implementation.

## Investigation Process

### 1. Fetch Issue Details

View the full issue with comments:
...
- Look for recent changes in affected areas
...
- **GitHub Issue ID**: #$ISSUE_NUMBER
- **Issue URL**: https://github.com/$REPOSITORY/issues/$ISSUE_NUMBER
- **Title**: $ISSUE_TITLE
- **Reporter**: [GitHub username from issue]
- **Severity**: [Critical/High/Medium/Low]
- **Status**: [Current status]

## Problem Description

[Clear description of the issue from $ISSUE_BODY]
...
This RCA document will be used by the implement-fix workflow.

## Next Steps

1. Review this RCA document
2. Implement the fix using the implement-fix workflow
3. Create PR and link to this issue
```

## Completion

After creating the RCA document, provide a summary:
