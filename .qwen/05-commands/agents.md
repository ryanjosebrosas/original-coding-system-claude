...
- Start with `QWEN.md` for project conventions
...
Read `.qwen/agents/research-codebase.md` as a structural reference.
...
Save to: `.qwen/agents/{agent-name}.md`

**Important**: If `.qwen/agents/` doesn't exist, create it.
...
Report to the user:
- Agent file path: `.qwen/agents/{agent-name}.md`
...
- Reminder: "Restart your Qwen Code session or start a new conversation to load the new agent"
