...
1. **Template is the control mechanism**: All research fill specific sections of `templates/STRUCTURED-PLAN-TEMPLATE.md`. Nothing is missed because the template specifies exactly what's needed.
...
8. **Recommended model**: Start planning sessions with a deep reasoning model. Better reasoning produces higher-quality plans — better scoping, more thorough codebase analysis, higher confidence scores.
...
@reference/6-phase-process.md

For template section-filling guide:
@reference/template-guide.md
